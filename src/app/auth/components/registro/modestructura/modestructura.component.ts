...
@Component({
  selector: 'app-modestructura',
  templateUrl: './modestructura.component.html',
  styleUrls: ['./modestructura.component.scss']
})
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: MODIFICACIÓN DE DATOS TÉCNICOS CAMBIO DE ESTRUCTURA', style: 'header' },
