...
@Component({
  selector: 'app-trjuridica',
  templateUrl: './trjuridica.component.html',
  styleUrls: ['./trjuridica.component.scss']
})
export class TrjuridicaComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: TRANSFERENCIA NORMAL PERSONA JURÍDICA', style: 'header' },
