...
@Component({
  selector: 'app-datostecnicos',
  templateUrl: './datostecnicos.component.html',
  styleUrls: ['./datostecnicos.component.scss']
})
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: MODIFICACIÓN DE DATOS TÉCNICOS', style: 'header' },
