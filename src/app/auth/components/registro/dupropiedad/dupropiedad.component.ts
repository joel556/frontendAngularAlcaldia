...
@Component({
  selector: 'app-dupropiedad',
  templateUrl: './dupropiedad.component.html',
  styleUrls: ['./dupropiedad.component.scss']
})
export class DupropiedadComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: Duplicado RUA 03 y/o CRPVA (Certificado de Registro de Propiedad de Vehículo Automotor)', style: 'header' },
