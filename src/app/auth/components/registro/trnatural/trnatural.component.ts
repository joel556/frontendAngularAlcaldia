...
@Component({
  selector: 'app-trnatural',
  templateUrl: './trnatural.component.html',
  styleUrls: ['./trnatural.component.scss']
})
export class TrnaturalComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: TRANSFERENCIA NORMAL PERSONA NATURAL', style: 'header' },
