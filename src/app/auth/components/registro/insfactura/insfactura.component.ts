...
@Component({
  selector: 'app-insfactura',
  templateUrl: './insfactura.component.html',
  styleUrls: ['./insfactura.component.scss']
})
export class InsfacturaComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de: INSCRIPCIÓN CON FACTURA COMERCIAL', style: 'header' },
