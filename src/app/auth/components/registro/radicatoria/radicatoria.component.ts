...
@Component({
  selector: 'app-radicatoria',
  templateUrl: './radicatoria.component.html',
  styleUrls: ['./radicatoria.component.scss']
})
export class RadicatoriaComponent implements OnInit {
  ...
  generatePDF() {
    ...
    if (contentElement) {
      ...
      const documentDefinition = {
        content: [
          { text: 'Requisitos para el tramite de CAMBIO DE RADICATORIA', style: 'header' },
